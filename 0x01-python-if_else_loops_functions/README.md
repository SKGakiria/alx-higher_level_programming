...
The program will assign a random signed number to the variable number each time it is executed. 
...
if the last digit is less than 6 and not 0: the string and 
...
3. When I was having that alphabet soup, I never thought that 
it would pay off
Write a program that prints the ASCII alphabet, in lowercase, 
not followed by a new line.
...
Write a function that creates a copy of the string, removing the character 
...
that does exactly the same as the Python bytecode provided:
